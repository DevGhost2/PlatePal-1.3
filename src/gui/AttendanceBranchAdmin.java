...
public class AttendanceBranchAdmin extends javax.swing.JPanel {

    private java.util.HashMap<String, String> employeeMap = new java.util.HashMap<>();
    public static AttendanceBranchAdmin aba;
    
    public AttendanceBranchAdmin() {
        initComponents();
        loadAttendance();
    ...
    public static synchronized AttendanceBranchAdmin getInstance() {
        if (aba == null) {
            aba = new AttendanceBranchAdmin();
        }
        return aba;
    }
    ...
    private void loadAttendance() {
        try {
            ...
            // Ensure we have the hidden column for internal ID
            ...
            while (resultset.next()) {
                ...
                vector.add(resultset.getString("emp_id")); // Employee ID (visible)
                vector.add(resultset.getString("first_name")); // First Name
                vector.add(resultset.getString("last_name")); // Last Name
                vector.add(resultset.getString("email")); // Email
                vector.add(resultset.getString("type")); // Employee Role
                vector.add(resultset.getString("id")); // Internal ID (hidden)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        ViewAttendanceDialog viewDialog = new ViewAttendanceDialog(null, true);
        viewDialog.setVisible(true);
    }                                        

    // Inner class for viewing attendance records
