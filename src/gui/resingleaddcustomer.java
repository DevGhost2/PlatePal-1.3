...
import static gui.addcustomer.GenderMap;
...
public class resingleaddcustomer extends javax.swing.JFrame {

    public static HashMap<String, Integer> employeeMap = new HashMap();

    public resingleaddcustomer() {
        initComponents();
        loademployee();
        lordgender();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String empname = String.valueOf(jComboBox2.getSelectedItem());
        ...
        } else if (empname.equals("Select")) {
            JOptionPane.showMessageDialog(this, "Please select an employee", "Warning", JOptionPane.WARNING_MESSAGE);
        } else {

            int empnid = employeeMap.get(empname);

            try {
                ResultSet resultSet = MySQL2.executeSearch("SELECT * FROM `customer` WHERE `mobile` = '" + mobile + "' AND `customer_id` != '" + id + "'");
                if (resultSet.next()) {
                    JOptionPane.showMessageDialog(this, "This mobile number is already in use.");
                } else {
                    ...
                    this.dispose(); // optional: close the window
                }

            } catch (Exception e) {
                e.printStackTrace();
                JOptionPane.showMessageDialog(this, "An error occurred while updating customer data.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resingleaddcustomer().setVisible(true);
            }
        });
    }
