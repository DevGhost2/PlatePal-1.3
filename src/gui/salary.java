...
public class salary extends javax.swing.JPanel {
    ...
    private void loadsalary() {
        try {
            ResultSet resultset = MySQL2.executeSearch(
                    "SELECT CONCAT('SV', LPAD(CAST(s.id AS CHAR), 5, '0')) AS idc, s.*,"
                    + "CONCAT('EMP', LPAD(CAST(e.id AS CHAR), 5, '0')) AS employee_idc, s.*, e.first_name, e.last_name "
            ...
            while (resultset.next()) {
                ...
                vector.add(resultset.getString("idc"));
                ...
                vector.add(resultset.getString("total_regular_hours"));
                vector.add("Rs. " + resultset.getString("paid_amount"));
    ...
    private void initComponents() {
        ...
        jButton2.setText("Add Salary Voucher");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Employee ID", "Employee Name", "Paid Date", "Total Hours", "Paid Amount"
            }
        ) {
...
//        paySalary.setVisible(true);
        ...
        paySalary.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
        ...
        paySalary.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE); // Required for windowClosed to fire
        paySalary.setVisible(true);
